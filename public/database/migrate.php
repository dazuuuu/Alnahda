<?php
/**
 * Migration runner (copied into public/database for cPanel access).
 *   php public/database/migrate.php            Run all pending migrations
 *   php public/database/migrate.php --fresh    Drop all known tables, then run every migration
 */
