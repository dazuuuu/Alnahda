<?php
/**
 * One-time/idempotent seed (copied into public/database/seeders for cPanel access):
 ...
 * Run: php public/database/seeders/DatabaseSeeder.php
 */
...
$dumpFile = dirname(__DIR__, 3) . '/origin_db/uhwlqvsp_alnahda.sql';
if (is_file($dumpFile)) {
